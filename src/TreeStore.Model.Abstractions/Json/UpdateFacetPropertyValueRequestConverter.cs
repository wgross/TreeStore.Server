...
{
    public sealed class UpdateFacetPropertyValueRequestConverter : JsonConverter<UpdateFacetPropertyValueRequest>
    {
        public override UpdateFacetPropertyValueRequest Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            var result = new UpdateFacetPropertyValueRequest(
                Id: id,
                Type: type,
                Value: value);
        ...
        public override void Write(Utf8JsonWriter writer, UpdateFacetPropertyValueRequest value, JsonSerializerOptions options)
        {
